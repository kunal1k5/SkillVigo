...
const SERVICE_DATA = {
  ...
  skill: {
    ...
    category: 'Education',
    description:
      'Specialized in CBSE Class 10 & 12 board preparations. I help students build a strong foundation in Algebra, Trigonometry, and Calculus with practical real-world examples.',
        ...
        <div className="flex-1">
          <div className="flex justify-between items-start">
            ...
            <div className="flex items-center gap-1 bg-yellow-50 text-yellow-700 px-2 py-1 rounded-lg text-sm font-semibold">
              ...
              <span className="text-yellow-600/70 font-normal">
      ...
      <form onSubmit={handleFormSubmit} className="space-y-5">
        ...
        <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <label
              className={`cursor-pointer p-3 border rounded-xl text-center text-sm font-medium transition-all ${
        ...
        <div className="mt-8 pt-6 border-t border-slate-100 space-y-3">
          ...
          <div className="flex justify-between font-bold text-slate-900 mt-2 pt-2">
